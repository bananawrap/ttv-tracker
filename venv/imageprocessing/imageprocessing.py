...
try:
    ...
    print("vitun idiootti sulla ei ees oo kuvaa siel")
    time.sleep(1)
    print("homo")
    time.sleep(1)
...
def outliner():
    global pixelList
    #This code is creating four lists of colors from a global list of pixels, 
    #then finding the average of each list and sorting them from highest to lowest. Finally, 
    #it calculates the shade modifier by finding the difference between the highest and lowest values in the list.
    color1 = []
    color2 = []
    color3 = []
    color4 = []
